      ...
      const localization = [
        {
          ...
          pckstudio2desc: "This program can be utilized to create and modify .PCK files, which are used in skin packs, texture packs, and mashup packs.",
          arcstudio2desc: "This program can be used to modify existing .ARC files, which are used in the display of strings, rendering of GUIs, and the loading of structure files.",
          msscmpstudio2desc: "his program can be used to create and modify .msscmp files, which are archives containing sound files for actions such as eating and breaking blocks.",
          ...
          texturetool2desc: "This program can be used to create the structure used for minecraft console texture packs!",
        ...
        },
        {
          ...
          pckstudio2desc: "このプログラムは、スキンパック、テクスチャパック、およびマッシュアップパックで使用される.PCKファイルを作成および変更するために使用できます。",
          arcstudio2desc: "このプログラムは、文字列の表示、GUIのレンダリング、および構造ファイルのロードに使用される既存の.ARCファイルを変更するために使用できます。",
          msscmpstudio2desc: "彼のプログラムを使用して、.msscmpファイルを作成および変更できます。このファイルは、ブロックを食べたり壊したりするなどのアクション用のサウンドファイルを含むアーカイブです。",
          msscmpstudio2desc2: "**警告**",
          msscmpstudio2desc3: "使用するサウンドファイルは同じサイズである必要があります。そうでない場合、サウンドはまったく再生されません。",
          texturetool2desc: "このプログラムを使用して、Minecraftコンソールテクスチャパックに使用される構造を作成できます。",
          development: "開発",
